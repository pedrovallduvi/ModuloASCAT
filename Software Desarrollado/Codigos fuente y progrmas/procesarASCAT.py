...
Se incluye una copia de este archivo en el directorio, cgi-bin es practicamente igual, pero al estar en la misma carpeta de los demas codigos se puede ejecutar desde cualquier ubicacion haciendo "python /home/..../cgi-bin/procesarASCAT.py arg1 arg2 arg3.
Por el contrario este archivo debe ser ejecutado luedo de haberse posicionado sobre la carpeta conetnedora.
"""
...
if cont > 4:
    if cont != 8:
        print "Parametros Obligados: File Path, Tecnica, Step. Parametros opcionales: Latitud Minima, latitud Maxima, longitud Minima, longitud Maxima."
